...
import {MockBvmL1CrossDomainMessenger} from './MockBvmL1CrossDomainMessenger.sol';

contract MockBvmL2CrossDomainMessenger is ICrossDomainMessenger {
  ...
  function sendMessage(
    ...
    MockBvmL1CrossDomainMessenger(l1Messenger).redirect(_target, _message, _gasLimit);
  }
